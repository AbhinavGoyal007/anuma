  ...
  public: {
    Tables: {
      ...
      interaction_field_definitions: {
        Row: {
          alternate_source_class: Database["public"]["Enums"]["fact_source_class"] | null;
          cardinality: string;
          created_at: string;
          created_by_membership_id: string | null;
          definition: string;
      ...
      interaction_field_values: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["organization_id", "conversation_id", "interaction_record_id"];
            isOneToOne: false;
    ...
    Enums: {
      ...
      fact_abstention: "not_stated" | "insufficient_evidence" | "ambiguous" | "unknown";
      fact_claimant: "representative" | "customer" | "other";
      fact_source_class: "verified" | "evidence_extracted" | "evaluated" | "inferred";
